...
def forward_backward_pipelining_with_interleaving(
    *,
    ...
    tensor_shape[0] = tensor_shape[0] // parallel_state.get_context_parallel_world_size() // parallel_state.get_ulysses_sequence_parallel_world_size()
...
def get_tensor_shapes(
    *,
    ...
    seq_length = seq_length // parallel_state.get_context_parallel_world_size() // parallel_state.get_ulysses_sequence_parallel_world_size()
    if model_type == ModelType.encoder_and_decoder:
        decoder_seq_length = decoder_seq_length // parallel_state.get_context_parallel_world_size() // parallel_state.get_ulysses_sequence_parallel_world_size()
