...
class TestExpertLayerReconfiguration:
    ...
    def test_parallel_reconfiguration_e2e(
        ...
        with TempNamedDir(tmp_path_dist_ckpt / 'test_expert_layer_reconfiguration_model_A') as ckpt_dir_A:
            with TempNamedDir(tmp_path_dist_ckpt / 'test_expert_layer_reconfiguration_model_B') as ckpt_dir_B:
                # Save checkpoint A
