...
def apply_patch(
    ...
    try:
        ...
        raise ValueError("Git apply {} falied! When this problem occurs, you can try the following operations: 1. Re-download FlagScale and unpatch again. 2. Use the git config command to set your mailbox and name".format(file_name))
