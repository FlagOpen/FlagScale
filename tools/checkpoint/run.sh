...
python convert.py \
    ...
    --loader mcore \
    --saver transformers \
    --load-dir /workspace/baai-opensp/FlagScale/DeepSeekV3_CKPT_Test_with_MTP/checkpoints \
    --save-dir deepseek_v3/converted_huggingface_model \
...
#     --loader transformers \
#     --saver mcore \
#     --load-dir deepseek_v3/bf16_model \
#     --save-dir deepseek_v3/converted_bf16_model \
#     --target-tensor-parallel-size 1 \
