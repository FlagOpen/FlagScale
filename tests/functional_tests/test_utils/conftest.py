...
def pytest_addoption(parser):
    ...
    parser.addoption(
        "--test_type", action="store", default="none", help="Different Types of Testing (train/inference/....)"
    )
    parser.addoption(
        "--test_model", action="store", default="none", help="Model name for the test cases"
    )
    parser.addoption(
