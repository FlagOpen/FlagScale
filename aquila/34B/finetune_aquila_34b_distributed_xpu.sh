...
VOCAB_FILE=${ROOT_DIR}/../../../../aquila/tokenizer/vocab.json
MERGE_FILE=${ROOT_DIR}/../../../../aquila/tokenizer/merges.txt
SPECIAL_TOKENS_FILE=${ROOT_DIR}/../../../../aquila/tokenizer/special_tokens.txt
