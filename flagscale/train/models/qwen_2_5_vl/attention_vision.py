...
from flagscale.train.models.qwen_2_5_vl.transformer_config import TransformerConfig
from flagscale.train.models.qwen_2_5_vl.rope_utils import (
...
class Attention(MegatronModule, ABC):
    ...
    def forward(
        ...
        #     print(f"LZY: rotary_pos_emb shape:{rotary_pos_emb[0].shape}, rotary_pos_emb[1] shape:{rotary_pos_emb[1].shape}")
        # else:
        #     print(f"LZY: rotary_pos_emb shape:{rotary_pos_emb.shape}")
        ...
        # print(f"LZY: query shape:{query.shape}, key shape:{key.shape}, value shape:{value.shape}")
        # ===================================================
