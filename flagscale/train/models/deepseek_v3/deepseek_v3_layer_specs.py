...
def get_deepseek_v3_with_transformer_engine_spec(
...
def get_deepseek_v3_decoder_block_spec(
    ...
    """GPT block spec."""
    assert use_transformer_engine is True
    layer_norm_impl = TENorm

    # Layer specs.
    dense_layer_spec = get_deepseek_v3_with_transformer_engine_spec(
        num_experts=None,
    ...
    moe_layer_spec = get_deepseek_v3_with_transformer_engine_spec(
