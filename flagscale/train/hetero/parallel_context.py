...
class ProcessMesh:
    ...
    def build_process_group(
        ...
        for logical_ranks in logical_ranks_list:
            ...
            group = create_group(ranks, timeout=self._timeout, backend=self._distributed_backend, pg_options=pg_options)
            if gloo:
                group_gloo = create_group(ranks, timeout=self._timeout, backend="gloo")
