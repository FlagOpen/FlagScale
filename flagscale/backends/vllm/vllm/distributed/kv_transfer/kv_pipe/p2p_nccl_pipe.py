...
class P2pNcclPipe:
    ...
    def __init__(self,
        ...
        self.flagcx = FLAGCXLibrary("/mine/ip122/tune_qwen/FlagCX/build/lib/libflagcx.so") # /mine/ip122/tune_qwen/FlagCX  /workspace/serving/FlagCX
