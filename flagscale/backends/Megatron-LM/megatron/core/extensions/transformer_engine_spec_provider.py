...
from megatron.core.extensions.transformer_engine import (
    ...
    TERowParallelLinear,
    TELoRAColumnParallelLinear,
    TELoRARowParallelLinear,
)
...
class TESpecProvider(BackendSpecProvider):
    ...
    def lora_column_parallel_linear(self) -> type:
        """Which column parallel lora linear module TE backend uses"""
        return TELoRAColumnParallelLinear
    
    def lora_row_parallel_linear(self) -> type:
        """Which row parallel lora linear module TE backend uses"""
        return TELoRARowParallelLinear
